...
public:
    ...
    void setupUi(QDialog *ManageLines)
    {
        ...
        tabWidget->setGeometry(QRect(-10, 0, 600, 400));
        ...
        doubleSpinBoxLatitude->setGeometry(QRect(70, 160, 101, 20));
        doubleSpinBoxLatitude->setMinimumSize(QSize(85, 20));
        doubleSpinBoxLatitude->setDecimals(3);
        ...
        doubleSpinBoxLongitude->setGeometry(QRect(70, 130, 101, 20));
        doubleSpinBoxLongitude->setMinimumSize(QSize(85, 20));
        doubleSpinBoxLongitude->setDecimals(3);
        ...
        lineEditStationName->setGeometry(QRect(20, 50, 141, 20));
        ...
        label_11->setGeometry(QRect(210, 20, 200, 20));
        ...
        textBrowserAddStaiton->setEnabled(true);
        textBrowserAddStaiton->setGeometry(QRect(440, 220, 140, 91));
        label_23 = new QLabel(tabAddStation);
        label_23->setObjectName(QStringLiteral("label_23"));
        label_23->setGeometry(QRect(20, 200, 191, 91));
        listWidget = new QListWidget(tabAddStation);
        listWidget->setObjectName(QStringLiteral("listWidget"));
        listWidget->setGeometry(QRect(210, 50, 200, 270));
        QIcon icon2;
        ...
        comboBoxConnectStation1->setGeometry(QRect(100, 170, 151, 20));
        ...
        comboBoxConnectStation2->setGeometry(QRect(100, 210, 151, 20));
        ...
        pushButtonConnect->setGeometry(QRect(170, 290, 80, 30));
        ...
        comboBoxConnectLine->setGeometry(QRect(100, 250, 151, 20));
