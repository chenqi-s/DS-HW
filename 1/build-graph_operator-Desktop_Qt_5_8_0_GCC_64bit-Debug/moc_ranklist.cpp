...
#include "../graph_operator2/ranklist.h"
...
QT_MOC_LITERAL(1, 9, 10), // "NodeChange"
...
QT_MOC_LITERAL(5, 46, 8) // "previous"
    ...
    "RankList\0NodeChange\0\0QTreeWidgetItem*\0"
    "current\0previous"
};
...
void RankList::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->NodeChange((*reinterpret_cast< QTreeWidgetItem*(*)>(_a[1])),(*reinterpret_cast< QTreeWidgetItem*(*)>(_a[2]))); break;
        default: ;
        }
    }
}
...
const QMetaObject RankList::staticMetaObject = {
    { &QTreeWidget::staticMetaObject, qt_meta_stringdata_RankList.data,
      qt_meta_data_RankList,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *RankList::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_RankList.stringdata0))
        return static_cast<void*>(const_cast< RankList*>(this));
